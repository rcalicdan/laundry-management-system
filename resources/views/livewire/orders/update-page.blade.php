<section class="w-full" x-data="{ showPaymentModal: false }" @open-payment-modal.window="showPaymentModal = true"
    @close-payment-modal.window="showPaymentModal = false">
    ...
    <!-- Payment Modal -->
    @include('components.contents.order-payment-modal')
</section>